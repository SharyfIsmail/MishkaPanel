...
{
    private final java.util.Map<Pair<Integer, Integer>, Class<? extends UsbSerialDriver>> mProbeTable =
    ...
    ProbeTable addDriver(Class<? extends UsbSerialDriver> driverClass) {
        ...
        final java.util.Map<Integer, int[]> devices;
        try {
            devices = (java.util.Map<Integer, int[]>) method.invoke(null);
        } catch (IllegalArgumentException | IllegalAccessException | InvocationTargetException e) {
            throw new RuntimeException(e);
        }

        for (java.util.Map.Entry<Integer, int[]> entry : devices.entrySet()) {
