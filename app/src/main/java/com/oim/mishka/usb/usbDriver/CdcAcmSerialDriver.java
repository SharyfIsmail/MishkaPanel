...
public class CdcAcmSerialDriver implements UsbSerialDriver {
    ...
    private final java.util.List<UsbSerialPort> mPorts;
    ...
    public class CdcAcmSerialPort extends CommonUsbSerialPort {
        ...
        protected void openInt(UsbDeviceConnection connection) throws IOException {
            if (mPortNumber == -1) {
                android.util.Log.d(TAG,"device might be castrated ACM device, trying single interface logic");
                openSingleInterface();
            } else {
                android.util.Log.d(TAG,"trying default interface logic");
                openInterface();
            }
        }
        ...
        private void openInterface() throws IOException {
            android.util.Log.d(TAG, "claiming interfaces, count=" + mDevice.getInterfaceCount());
            ...
            android.util.Log.d(TAG, "Control iface=" + mControlInterface);
            ...
            android.util.Log.d(TAG, "data iface=" + mDataInterface);
    ...
    public static java.util.Map<Integer, int[]> getSupportedDevices() {
        final java.util.Map<Integer, int[]> supportedDevices = new LinkedHashMap<Integer, int[]>();
