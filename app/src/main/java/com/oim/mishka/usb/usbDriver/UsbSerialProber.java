...
public class UsbSerialProber
{
     ...
     */
    public java.util.List<UsbSerialDriver> findAllDrivers(final UsbManager usbManager) {
        final java.util.List<UsbSerialDriver> result = new ArrayList<UsbSerialDriver>();
